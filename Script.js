...
<div class="ui inverted segment">
  ...
  <div class="ui inverted form">
	...
	<div class="field" id="botname">        <label>Bot Name</label>

        <div class="ui large labeled input"><input type="text" value="Deneme" placeholder="Nickname" maxlength="14" spellcheck="false" data-ms-editor="true"></div>
...
<a href="https://github.com/ryzexms/gartic.io-bot" target="_blank" class="ui right floated
